...
@Autonomous
@Disabled
public class Blue_Left_3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj4 = drive.trajectorySequenceBuilder(traj3.end())
                ...
                .lineToLinearHeading(new Pose2d(48, 8, Math.toRadians(-6)),
                        SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        TrajectorySequence traj5 = drive.trajectorySequenceBuilder(traj4.end())
                .lineToLinearHeading(new Pose2d(54.5, 8, Math.toRadians(-4)))
                .build();
        TrajectorySequence traj6 = drive.trajectorySequenceBuilder(traj5.end())
                ...
                .lineToLinearHeading(new Pose2d(48, 8, Math.toRadians(-4)),
                        SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        while (!isStarted() && !isStopRequested()) {
            ...
            if (tagOfInterest == null || tagOfInterest.id == LEFT) {
                trajFinal = drive.trajectorySequenceBuilder(traj8.end())
                        ...
                        .lineToLinearHeading(new Pose2d(56, 9, Math.toRadians(-6)))

                        .build();
            } else if (tagOfInterest.id == MIDDLE) {
                trajFinal = drive.trajectorySequenceBuilder(traj8.end())

                        .lineToLinearHeading(new Pose2d(36, 9, Math.toRadians(-6)))
                        .build();
            } else {
                trajFinal = drive.trajectorySequenceBuilder(traj8.end())
                        .lineToLinearHeading(new Pose2d(13, 9, Math.toRadians(-6)))
